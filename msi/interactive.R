...
# In the non-parallelized version of the model the user time is 306.541, the system time is 1.108, and the total time elapsed is 309.558 
# In the parallelized version of the model the user time is 1.566 seconds, the system time is .070, and the total time elapsed is 339.654
write_csv(tibble(nonparallelized = exec_time_nonparallelized, paralellized=exec_time_parallelized), "../interactive.csv", col_names=TRUE, append=TRUE)
